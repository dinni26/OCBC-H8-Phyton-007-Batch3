...
print("====contoh 6 (Keyword Argument)====")
...
print("====contoh 7 (Default Arguments)====")
...
def print_pets( name, *pets ):
   '''This prints name and list of pets they have'''
   print('name : ', name)
   print('pets : ', pets)
...
# Now you can call print_pets function
print_pets('Amy', 'cats')
